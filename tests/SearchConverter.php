...
final class SearchConverter extends TestCase
{
    ...
    public function testBasicPrimaryCountry(): void
    {
      $this->assertEquals(
        ...
        convertToAPI('https://reliefweb.int/updates?advanced-search=(PC13)')
      );
    }

    public function testDateRange(): void
    {
      $aurl = convertToAPI('https://reliefweb.int/updates?advanced-search=(PC13_DA20190801-20190829)');
      $aurls = [
    ...
    {
      $aurl = convertToAPI('https://reliefweb.int/updates?advanced-search=(PC13_DA20190801-)#content');
      $aurls = [
    ...
    {
      $aurl = convertToAPI('https://reliefweb.int/updates?advanced-search=(PC13_DA-20190801)#content');
      $aurls = [
    ...
    {
      $aurl = convertToAPI('https://reliefweb.int/updates?advanced-search=(PC13_S1503)#content');
      $aurls = [
